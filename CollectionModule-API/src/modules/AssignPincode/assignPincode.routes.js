...
const {pincodeListHandler, usernameHandler, userPincodeHandler, pincodeAssignHandler, pincodeMasterInsertHandler, PincodeHandler} = require('./assignPincode.controller');
