      ...
      <div className="page-users">
        ...
        {/* <div className="users-insight-row mb-3">
          ...
          <div className="users-insight users-insight-active">
            <span className="users-insight-icon">✓</span>
            <span className="users-insight-label">Active Users</span>
            <span className="users-insight-value">
              {counts.active}
            </span>
            <span className="users-insight-meta">98.09% of Total</span>
          </div>
          <div className="users-insight users-insight-inactive">
            <span className="users-insight-icon">✗</span>
            <span className="users-insight-label">Inactive Users</span>
            <span className="users-insight-value">
              {counts.inactive}
            </span>
            <span className="users-insight-meta">0.14% of Total</span>
          </div>
        </div> */}
              ...
              <div className="card-body d-flex align-items-center justify-content-between">
                ...
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted small">All registered users</div>
                  </div>
                </div>
          ...
          <div className="col-md-4">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-body d-flex align-items-center justify-content-between">
                ...
                <div className="d-flex align-items-center gap-3">
                  <div className="bg-success-subtle text-success rounded-circle d-flex align-items-center justify-content-center"
                    style={{ width: "50px", height: "50px", fontSize: "22px" }}>
                  ...
                  <div>
                    ...
                    <h5 className="mb-0 fw-bold">{counts.active}</h5>
                    <div className="text-success small">98.09% of total</div>
                  </div>
                </div>
          ...
          <div className="col-md-4">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-body d-flex align-items-center justify-content-between">
                ...
                <div className="d-flex align-items-center gap-3">
                  <div className="bg-danger-subtle text-danger rounded-circle d-flex align-items-center justify-content-center"
                    style={{ width: "50px", height: "50px", fontSize: "22px" }}>
                  ...
                  <div>
                    ...
                    <h5 className="mb-0 fw-bold">{counts.inactive}</h5>
                    <div className="text-danger small">0.14% of total</div>
                  </div>
                </div>
            ...
            <div className="card widget-stat-progress">
              <div className="card-body">
                ...
                <div className="widget-stat-content">
                  ...
                  <span className="widget-stat-value fs-5">{counts.total}</span>
                  {/* <span className="widget-stat-meta">All registered users</span> */}
                </div>
            ...
            <div className="card widget-stat-progress">
              <div className="card-body">
                ...
                <div className="widget-stat-content">
                  ...
                  <span className="widget-stat-value fs-5">{counts.active}</span>
                  {/* <span className="widget-stat-meta">All registered users</span> */}
                </div>
            ...
            <div className="card widget-stat-progress">
              <div className="card-body">
                ...
                <div className="widget-stat-content">
                  ...
                  <span className="widget-stat-value fs-5">{counts.inactive}</span>
                  {/* <span className="widget-stat-meta">All registered users</span> */}
                </div>
