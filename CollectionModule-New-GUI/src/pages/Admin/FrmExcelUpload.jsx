        ...
        <div className="card-body py-4">
          <div className="mx-auto" style={{ maxWidth: '800px' }}>
            ...
            <div
              ...
              style={{ cursor: 'pointer', transition: 'all 0.2s', borderStyle: 'dashed', borderWidth: '2px', borderColor: dragOver ? 'var(--accent-color)' : '#dee2e6' }}
            ...
            >
              {file ? (
                <div>
                  <i className="bi bi-file-earmark-excel text-success" style={{ fontSize: '2.5rem' }} />
                ...
                <div>
                  <i className="bi bi-cloud-upload text-muted" style={{ fontSize: '2.5rem' }} />
                  <div className="mt-2 fw-semibold">Drag & drop your Excel file here</div>
                  <div className="text-muted small mb-2">or click to browse</div>
                  <span className="badge bg-secondary">Supports .xlsx and .xls</span>
                </div>
              )}
            </div>
            ...
            <div className="d-flex justify-content-center">
              ...
              >
                {uploading
                  ...
                  : <><i className="bi bi-upload me-2" />Upload & Process</>
                }
              </button>
            </div>
