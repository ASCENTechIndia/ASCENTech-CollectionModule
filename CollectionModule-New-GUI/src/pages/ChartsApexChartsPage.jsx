    ...
    <div className="main-content page-charts-apexcharts">
          ...
          <div className="col-lg-6">
            <ChartCard title="Basic Line Chart">
              <ReactApexChart
                options={{
                  ...common,
                  chart: { ...common.chart, type: "line", height: 280 },
          ...
          <div className="col-lg-6">
            <ChartCard title="Multi-Line Chart">
              <ReactApexChart
                ...
                series={[
                  { name: "Desktop", data: [45, 52, 38, 24, 33, 26, 21] },
                  { name: "Mobile", data: [35, 41, 62, 42, 13, 18, 29] },
                  { name: "Tablet", data: [87, 57, 74, 99, 75, 38, 62] },
                ]}
                type="line"
                height={280}
              />
            ...
            <ChartCard title="Gradient Line Chart">
              <ReactApexChart
                options={{
                  ...
                  xaxis: {
                    categories: Array.from({ length: 18 }, (_, i) => i + 1),
                  },
                }}
                series={[
                  {
          ...
          <div className="col-lg-6">
            <ChartCard title="Step Line Chart">
              <ReactApexChart
                ...
                series={[
                  { name: "Step Series", data: [34, 44, 54, 21, 12, 43, 33] },
                ]}
                type="line"
                height={280}
              />
      ...
      <section className="section">
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-6">
            <ChartCard title="Stacked Area Chart">
              <ReactApexChart
                options={{
                  ...common,
                  chart: {
                ...
                series={[
                  ...
                  {
                    name: "North",
                    data: [11, 32, 45, 32, 34, 52, 41, 60, 55, 70, 65, 50],
                  },
                  {
                    name: "Central",
                    data: [15, 25, 35, 20, 28, 38, 30, 40, 38, 45, 42, 35],
                  },
                ]}
                type="area"
                height={280}
      ...
      <section className="section">
        ...
        <div className="row g-4">
          <div className="col-lg-6">
            <ChartCard title="Basic Column Chart">
              <ReactApexChart
                options={{
                  ...common,
          ...
          <div className="col-lg-6">
            <ChartCard title="Grouped Bar Chart">
              <ReactApexChart
                ...
                series={[
                  { name: "2019", data: [44, 55, 41, 37] },
                  { name: "2020", data: [76, 85, 101, 98] },
                ]}
                type="bar"
                height={280}
              />
          ...
          <div className="col-lg-6">
            <ChartCard title="Stacked Column Chart">
              <ReactApexChart
                options={{
                  ...common,
                  chart: {
      ...
      <section className="section">
        ...
        <div className="row g-4">
          <div className="col-lg-6">
            <ChartCard title="Line & Column Mixed">
              <ReactApexChart
                options={{
                  ...common,
                  chart: { ...common.chart, type: "line", height: 280 },
          ...
          <div className="col-lg-6">
            <ChartCard title="Multiple Y-Axis">
              <ReactApexChart
                options={{
                  ...common,
                  chart: { ...common.chart, type: "line", height: 280 },
                ...
                series={[
                  {
                    name: "Revenue",
                    type: "column",
                    data: [4400, 5050, 4200, 5800, 4800, 6200],
                  },
                  {
                    name: "Orders",
                    type: "line",
                    data: [44, 55, 41, 67, 45, 72],
                  },
                ]}
                type="line"
                height={280}
