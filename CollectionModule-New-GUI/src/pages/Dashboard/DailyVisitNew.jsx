...
const   DailyVisitNew = () => {
  ...
  const totalAccountsData = useChart(
    (context) =>
      new Chart(context, {
        type: "doughnut",
        data: {
  ...
  const totalVisitsData = useChart(
    (context) =>
      new Chart(context, {
        type: "doughnut",
        data: {
  ...
  const fosAssignedData = useChart(
    (context) =>
      new Chart(context, {
        type: "pie",
        data: {
          ...
          datasets: [
            {
              data: [
                ...
                Math.max(
                  0,
                  100 - (dashboardData?.allocation?.fosAssignedPercent || 0),
                ),
              ],
              backgroundColor: [
                commonColors.accent,
  ...
  const ptpConversionData = useChart(
    (context) =>
      new Chart(context, {
        type: "pie",
        data: {
              ...
              children: [
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      name: "BORROWER\nABUSIVE/\nAGGRES\nSIVE",
                      value:
                        dashboardData?.dispositionSunburst?.borrowerAbusive,
                      itemStyle: {
                      ...
                      children: [
                        {
                          name: "SHORT\nADDRESS",
                          value:
                            dashboardData?.dispositionSunburst?.shortAddress,
                          itemStyle: {
                        ...
                        },
                        {
                          name: "ADDRESS\nNOT\nFOUND",
                          value:
                            dashboardData?.dispositionSunburst?.addressNotFound,
                          itemStyle: {
              ...
              <div className="card-body d-flex flex-column flex-grow-1">
                ...
                <div className="mt-auto">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span className="fw-medium">
                      {dashboardData?.allocation?.totalAssignedFOS || 0}
                    </span>
                  </div>
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <div className="d-flex align-items-center gap-2">
                    ...
                    <span className="fw-medium">
                      {dashboardData?.allocation?.totalUnassignedFOS_alt || 0}
                    </span>
                  </div>
                </div>
              </div>
